...
class UserRepository extends BaseRepository
{
    ...
    {
        if (null === $user = $this->objectRepository->findOneBy(['id' => $id, 'token' => $token])) {
    ...
    public function findOneInactiveByIdAndResetPasswordTokenOrFail(string $id, string $resetPasswordToken): User
    {
